...
import { FaBell, FaTachometerAlt, FaTicketAlt, FaBars, FaTimes, FaUserCircle, FaSignOutAlt, FaChevronDown, FaUser } from 'react-icons/fa';
import logo from '/src/assets/logo.jpg';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';

const AgentNavbar = ({ activeItem = 'Dashboard', title = 'YipHelp Agent', notifications = 0 }) => {
    ...
    <div className="relative">
      ...
      <div className="flex h-14 w-full bg-white border-b border-gray-200 shadow-sm">
        ...
        <div className="flex items-center px-4">
          ...
          <span className="ml-3 text-base font-bold hidden md:block lg:hidden">Agent</span>
          <span className="ml-3 text-base font-bold md:hidden">Agent</span>
        </div>
          ...
          <div className="relative" ref={profileRef}>
            ...
            {profileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                <Link to="/agent/profile" className="flex items-center px-4 py-2 text-sm text-pink-500 hover:bg-pink-50">
