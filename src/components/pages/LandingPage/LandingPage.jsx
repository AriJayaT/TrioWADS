...
// Import images
import jellycat1 from '../../../assets/landingpage/jellycat1.png';
import jellycat2 from '../../../assets/landingpage/jellycat2.png';
import jellycat3 from '../../../assets/landingpage/jellycat3.png';
import jellycat4 from '../../../assets/landingpage/jellycat4.png';
import jellycat5 from '../../../assets/landingpage/jellycat5.png';
import jellycat6 from '../../../assets/landingpage/jellycat6.png';

import car1 from '../../../assets/carousell/car1.png';
import car2 from '../../../assets/carousell/car2.png';
import car3 from '../../../assets/carousell/car3.png';
import car4 from '../../../assets/carousell/car4.png';

// Background Images Component 
const BackgroundImages = () => {
  // These images will be imported by the user
  const imagePositions = [
    { img: jellycat1, top: '5%', left: '3%', rotate: '-5deg', size: '120px', opacity: '0.5', zIndex: '1' },
    { img: jellycat2, top: '15%', right: '5%', rotate: '8deg', size: '100px', opacity: '0.5', zIndex: '1' },
    { img: jellycat3, bottom: '25%', left: '8%', rotate: '12deg', size: '110px', opacity: '0.5', zIndex: '1' },
    { img: jellycat4, bottom: '10%', right: '7%', rotate: '-10deg', size: '90px', opacity: '0.5', zIndex: '1' },
    { img: jellycat5, top: '50%', left: '20%', rotate: '15deg', size: '80px', opacity: '0.5', zIndex: '1' },
    { img: jellycat6, top: '40%', right: '15%', rotate: '-8deg', size: '95px', opacity: '0.5', zIndex: '1' },
  ];
