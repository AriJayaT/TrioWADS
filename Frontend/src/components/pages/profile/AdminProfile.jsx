...
import { FaUser, FaEnvelope, FaPhone, FaLock, FaSave, FaSpinner, FaUserShield, FaTimes } from 'react-icons/fa';
...
const AdminProfile = () => {
  ...
  return (
    <>
      <AdminNavbar activeItem="Profile" />
      <div className="min-h-screen bg-pink-50">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-bold">Admin Profile</h1>
            <div className="px-4 py-1 bg-pink-100 text-pink-600 rounded-full text-sm font-medium">
              <FaUserShield className="inline mr-1" /> Administrator
            </div>
          </div>
              ...
              <div className="bg-white shadow rounded-lg mb-6">
                <div className="flex border-b">
                  ...
                  <div className="ml-auto flex items-center">
                    <Link to="/admin" className="text-pink-500 hover:text-pink-700 text-sm font-medium px-6 py-3">
                      Back to Dashboard
                    </Link>
                  </div>
                </div>
