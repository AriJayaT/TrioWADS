...
const TicketRatingForm = ({ ticketId, onSubmit }) => {
  ...
  const handleRatingSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Submitting rating:', ratingData, 'for ticket:', ticketId);
      ...
      if (err && err.response && err.response.data && err.response.data.error) {
        ...
        switch (err.response.status) {
          case 400:
            errorMessage = 'Invalid rating data. Please check your rating and try again.';
            break;
          case 403:
            errorMessage = 'You are not authorized to rate this ticket.';
            break;
          case 404:
          ...
          case 500:
            ...
            break;
          default:
            errorMessage = `An error occurred (${err.response.status}). Please try again.`;
        }
