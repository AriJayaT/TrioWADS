    ...
    <div className="mt-8">
      <div className="bg-white shadow-lg overflow-hidden rounded-4xl p-6 hover:shadow-pink-200">
        ...
        {agents.map((agent, index) => (
          <div key={agent.id} className={`flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border border-pink-200 rounded-2xl mb-4 text-black ${index !== agents.length - 1 ? 'border-b' : ''}`}>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-0 w-full sm:w-auto text-black">
